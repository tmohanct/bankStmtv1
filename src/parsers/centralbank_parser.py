...
from src.utils.statement_utils import clean_cell, is_date_token, parse_amount
...
BANK_CODE = 'central'
BANK_SIGNATURES = (('CENTRAL BANK OF INDIA', 5), ('CBIN0', 3), ('CBIN', 1))
