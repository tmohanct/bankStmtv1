...
PDF_STATUS_PROFILE = {
    ...
    "name_after": "Current & Saving Account Statement"
}
...
BANK_CODE = 'canara'
BANK_SIGNATURES = (('CNRB0', 4), ('STATEMENT FOR A/C', 2), ('DEPOSITS WITHDRAWALS BALANCE', 1), ('CURRENT & SAVING ACCOUNT STATEMENT', 8))
