...
from src.transform.normalize import extract_cheque_number_from_details, normalize_cheque_number
...
BANK_CODE = 'sbi'
BANK_SIGNATURES = (('STATE BANK OF INDIA', 4), ('IFS CODE :SBIN', 5), ('IFS CODE: SBIN', 5), ('SBIN0', 3), ('SBINO', 3))
